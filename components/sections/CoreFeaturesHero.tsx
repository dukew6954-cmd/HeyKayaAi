...
import { ArrowRight, Zap, Settings, Shield, Clock, Users } from 'lucide-react'
...
const coreFeatures = [
  {
    ...
    description: "Core automation tools included in every plan"
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: "Always-on platform with 99.9% uptime"
  }
]
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-white font-semibold">Core Platform Features</span>
            <motion.div
          ...
          >
            Pavro's core platform includes all the essential features you need to automate your business. 
            No hidden fees, no add-ons required - everything is built into the platform.
          </motion.p>
